...
public class LoginClientTest {
    ...
    @Test
    public void shouldValidateSessionID() {
        SessionIdValidationResponse sessionIdValidationResponse = TestDataHelper.createSessionIdSuccessResponse();

        Optional<SessionIdValidationResponse> loginPlayerResponse
                = loginClient.validateSession("someSessionId");
